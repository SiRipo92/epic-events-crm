...
by Alembic's env.py to detect all tables for auto-generate migrations.

Usage:
    from models import Base, Collaborator, Role, Client, Contract, Event
"""
...
__all__ = ["Base", "Collaborator", "Role", "Client", "Contract", "Event"]
